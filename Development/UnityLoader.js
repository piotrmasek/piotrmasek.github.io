...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'piotrmasek.github.io.data';
    var REMOTE_PACKAGE_BASE = 'piotrmasek.github.io.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 12722386;
      var PACKAGE_UUID = 'db07a9d8-a58b-4230-81e0-b3cdb476adfc';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 9659790, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(9659790, 9659996, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(9659996, 11199460, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(11199460, 12694760, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(12694760, 12722386, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_piotrmasek.github.io.data');

    };
    Module['addRunDependency']('datafile_piotrmasek.github.io.data');
